...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="nav navbar-nav">
            ...
            <a class="nav-item nav-link active" href="baseDatos.php" role="button">Base de datos</a>
